...
// HM_ prefix avoids clashing with QMK built-in mod-tap macros (CTL_T, SFT_T, ...).
// Left hand
...
#define HM_I LALT_T(KC_I)   // skeletyl uses LALT for I
...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [_BASE]  = LAYOUT(
        ...
        KC_LSFT,  HM_A,     HM_R,     HM_S,     HM_T,     KC_D,     KC_H,     HM_N,     HM_E,     HM_I,     HM_O,     KC_QUOT,
  ...
  [_LOWER] = LAYOUT(
        ...
        KC_TRNS,  UG_TOGG,  UG_NEXT,  UG_HUEU,  UG_SATU,  UG_VALU,  KC_HOME,  KC_PGDN,  KC_PGUP,  KC_END,   KC_INS,   KC_TRNS,
        KC_TRNS,  KC_TRNS,  KC_TRNS,  KC_TRNS,  KC_TRNS,  KC_TRNS,  KC_TRNS,  KC_TRNS,  KC_TRNS,  KC_TRNS,  KC_TRNS,  KC_TRNS
    ),
  ...
  [_RAISE] = LAYOUT(
        ...
        KC_TRNS,  KC_TRNS,  KC_TRNS,  KC_TRNS,  KC_TRNS,  UG_TOGG,  UG_NEXT,  KC_TRNS,  KC_TRNS,  KC_TRNS,  KC_TRNS,  KC_TRNS
    )
